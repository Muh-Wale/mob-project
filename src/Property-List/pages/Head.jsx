...
const Head = () => {
    ...
    return (
        <div className='max-w-[1640px] projects-six max-h-[100vh] md:max-h-[80vh] mx-auto py-[20px] px-5 md:px-14 lg:px-24'>
            <div className=' max-w-[1400px] mx-auto h-full'>
                ...
                <div className=' max-w-[1000px] mx-auto w-full flex flex-col justify-end h-full'>
                    <div className='mx-auto text-white text-center font-semibold md:font-bold text-2xl md:text-4xl lg:text-6xl capitalize my-[20px] md:my-[70px] lg:my-[100px] max-w-full md:max-w-[500px] lg:max-w-[760px] w-full'>
                        <h1>browse through our selected properties</h1>
                    </div>
                    <div>
